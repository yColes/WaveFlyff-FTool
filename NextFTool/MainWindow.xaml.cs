...
namespace NextFTool
{
    ...
    {
        Color pause_color = (Color)ColorConverter.ConvertFromString("#c62906"); // Color of the Stop Button
        Color play_color  = (Color)ColorConverter.ConvertFromString("#c62906"); // Color of the Play Button
        ...
        private void Start_Stop_Action(string index)
        {
            ...
            if (spammers.ContainsKey(index))
            {
                ...
                else
                {
                    ...
                    {
                        new MessageBoxCustom("Selecione uma tecla F");
                        return;
                    }
            ...
            {
                new MessageBoxCustom("Selecione um processo");
            }
        }
        ...
        private void ActivateSpammer(Spammer spammer, string index)
        {
            ...
            {
                new MessageBoxCustom("Tenha certeza que o atraso e maior que " + Spammer.Min_delay + " ms.");
                return;
            }                       
            ToggleStartIcon(index);
        }
        ...
        private int GetFKeyFromInput(string index)
        {
            ...
            {
                case "-":
                    throw new NoFKeyException("Por favor seleciona uma tecla F");
                case "0": 
        ...
        {           
            switch (index)
            {
                ...
                case "5":
                    return Start_Icon_5;
                default:
                    throw new Exception("Não há ícone Iniciar");
            }           
        }
